...
public class JavaStreams {
	...
	public static void main(String[] args) throws IOException{
		...
		//8. streams rows from text file, sort, filter and print with more than 15 character
			    Stream<String> cricketer = Files.lines(Paths.get("C:\\Users\\Aaditya Raj\\eclipse-workspace\\MyCoreJava\\CodePractice\\bin\\test\\cricketer.txt"));
			    cricketer
			    .sorted()
	   ...
	   //9. streams rows from text file, sort, filter and print substring
			    List<String> cricketer2 = (List<String>) Files.lines(Paths.get("C:\\Users\\Aaditya Raj\\eclipse-workspace\\MyCoreJava\\CodePractice\\bin\\test\\cricketer.txt"))
       ...
       //10. Stream rows from CSV file and filter out which rows don't have 3 item array and count all which have 3 items in it.
			    Stream<String> rows1 = Files.lines(Paths.get("C:\\Users\\Aaditya Raj\\eclipse-workspace\\MyCoreJava\\CodePractice\\bin\\test\\data.txt"));
	   ...
	   //11. Stream rows from CSV file, and parse data from rows
			    Stream<String> rows2 = Files.lines(Paths.get("C:\\Users\\Aaditya Raj\\eclipse-workspace\\MyCoreJava\\CodePractice\\bin\\test\\data.txt"));
			    rows2
			    	.map(x -> x.split(", "))
			    	.filter(x -> x.length == 4)
	   ...
	   //12. Stream rows from CSV file, store fields in HashMap as key-value pair
			    Stream<String> rows3 = Files.lines(Paths.get("C:\\Users\\Aaditya Raj\\eclipse-workspace\\MyCoreJava\\CodePractice\\bin\\test\\data.txt"));
